...
public class ReferenceParserBenchmarks {
	...
	public int ParseWithLastTransaction() {
		ReferenceFraudRequestParser.TryParse(this.payloadWithLastTransaction, out var request);
		return request.Merchant.Mcc;
	}

	[Benchmark]
	public int ParseWithoutLastTransaction() {
		ReferenceFraudRequestParser.TryParse(this.payloadWithoutLastTransaction, out var request);
		return request.Merchant.Mcc;
	}
}
